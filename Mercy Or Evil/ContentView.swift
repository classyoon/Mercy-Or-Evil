...
struct ContentView: View {
    ...
    @State var painCount = 0
    @State var evilCount = 0
    @State var mercyCount = 0
    @State var waryCount = 0
    @State var hostileCount = 0
    ...
    let hostile =  ["sus", "I'm watching you", "*intense glare*", "I know you're thinking about it.", "I know you're thinking about it.", "thanks... I guess", "*cowers in fear*", "*cowers in fear*", "Imma get you", "You know not what you do", "You seem untrustworthy"]
    let suprise = ["Wah!", "Noo-!", "Oh Go-!", "Ga-!", "Why?!"]
    let resigned = ["Wah!", "Noo-!", "Oh Go-!", "Ga-!", "Oh I swear-!", "Why?!", "Not again!", "Not again!", "Don't"]
    ...
    var body: some View {
        ...
        //                    .scaledToFit()
                    ...
                    VStack{
                        //                    Text("Screams \(painCount)")
                                           Text("Mood : \(mood), Grudge : \(hostileCount)")
...
extension ContentView {
    func handleEvilButtonPress() {
        ...
        if mercy {// If you were nice before then suddenly evil you will get suprise
            if (evilCount>2){//If you were evil in the past then merciful
                buttonlabel = resigned[Int.random(in: 0..<resigned.count)]
                mercyCount = 0
                mercy = false
                mood = "exasperated"
            }
    ...
    func handleMercyButtonPress(){
        ...
        default:
            buttonlabel = "REALLY?"
            mood = "exasperated (this seemed excessive)"
        }
        mercy = true
        color = .green
        fontsize = .body
